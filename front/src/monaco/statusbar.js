// @ts-nocheck
// Custom status bar for monaco-vim
// Modified from https://github.com/brijeshb42/monaco-vim/blob/master/src/statusbar.js
export default class VimStatusBar {
	constructor(node, editor, sanitizer = null) {
		...
		this.keyInfoNode.setAttribute('style', 'float: right;display:none;')
