export const PREFERENCE_KEYS = [
	...
	'editor.guides.highlight-active-indentation',
...
export const COMPLETION_KEY_TO_INDEX: Record<CompletionKey, CompletionIndex> = {
	...
	StoreKey: CompletionIndex.StoreKey,
...
export interface Guides {
	 ...
	 */
	'bracket-pairs': boolean
	/**
	 * Enable rendering of vertical bracket pair guides.
	 */
	'bracket-pairs-horizontal': boolean
	/**
	 * Enable highlighting of the active bracket pair.
	 */
	'highlight-active-bracket-pair': boolean
	/**
	 ...
	 */
	'highlight-active-indentation': boolean
}
/**
